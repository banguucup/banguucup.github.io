    ...
    <div class="main" ref="main">
      <div class="text">
        ...
        <form @submit="send">
          ...
          <div class="name">
            <input type="text" placeholder="Name" required v-model="name" name="name" />
          </div>
          <div class="email">
            <input type="email" placeholder="Email address" name="email" required v-model="email" />
          </div>
          <div class="message">
            <textarea id cols="30" rows="10" placeholder="Your Message" name="message" required v-model="message"></textarea>
          </div>
      ...
      <div class="social">
        <a class="email media" href="https://mail.google.com/">
          ...
          <p id="test">Yusuffirmansyah865@gmail.com</p>
        </a>
        <a class="github media" href="https://github.com/banguucup">
          <div class="icon">
            <i class="fab fa-github"></i>
          </div>
          <p>banguucup</p>
        </a>
        <a class="Linkedln media" href="https://linkedin.com/in/yusuf-firmansyah-6b662122a">
          <div class="icon">
            <i class="fab fa-linkedin"></i>
          </div>
          <p>Yusuf Firmansyah</p>
        </a>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      email: "",
      message: "",
      statusMessage: "Your Message has been sent successfully, I will contact you very soon !",
  ...
  methods: {
    send(e) {
      if (this.checkAnswer.toString() != this.answer) {
        ...
        axios
          .post("https://formsubmit.co/ajax/yusuffirmansyah865@gmail.com", {
            name: this.name,
            email: this.email,
          ...
          .then((res) => {
            ...
            this.statusMessage = "Your Message has been sent successfully, I will contact you very soon !";
          ...
          .catch((err) => {
            ...
            this.isShowingStatus = true;
            this.isLoading = false;
            this.statusMessage = "Some error has occured, Please try again next time !";
